...
const solutions = [
    {
        ...
        href: '/dashboard/appServiceManager/serviceAccounts',
        icon: ChartPieIcon,
    },
    {
    ...
    {
        name: 'API Keys & Secrets Management',
        description:
...
export default function AppServiceManagerQuickNavMenu() {
    return (
        <Popover className="relative">
            <Popover.Button className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
                <span>App Service Manager</span>
